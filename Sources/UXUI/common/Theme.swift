...
internal class Theme {
   ...
   struct Switch {
      struct Selected {
         static let foreground: Color = .init(light: #colorLiteral(red: 0.8973688483, green: 0.8920346498, blue: 0.9014693499, alpha: 1), dark: #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1))
         static let background: Color = .systemGreen
      }
      struct UnSelected {
         static let foreground: Color = .init(light: #colorLiteral(red: 0.7465752959, green: 0.742138803, blue: 0.749986589, alpha: 1), dark: #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1))
         static let background: Color = .init(light: #colorLiteral(red: 0.4756349325, green: 0.4756467342, blue: 0.4756404161, alpha: 1), dark: #colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1))
      }
   }
   struct CheckBox {
      struct Checked {
         static let foreground: Color = .systemBlue
         static let background: Color = .init(light: #colorLiteral(red: 0.7465752959, green: 0.742138803, blue: 0.749986589, alpha: 1), dark: #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1))
      }
      struct UnChecked {
         static let foreground: Color = .init(light: #colorLiteral(red: 0.7465752959, green: 0.742138803, blue: 0.749986589, alpha: 1), dark: #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1))
         static let background: Color = .init(light: #colorLiteral(red: 0.4756349325, green: 0.4756467342, blue: 0.4756404161, alpha: 1), dark: #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1))
      }
   }
   struct Background {
